	...
	<div class="container"  >
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-1">
								<img src="/public/common/image/koreatech.PNG" id="koreatechImage">
							</div>
							<div class="col-lg-8" style="margin-left: 180px;">
								<p>31253) 충청남도 천안시 동남구 병천면 충절로 1600 (가전리, 한국기술교육대학교) B104 </p>
								<p>Tel. 010-9368-5828 / 010-2666-0385</p>
								<p>Copyright &copy; UOC Lab 2016. All rights reserved</p>
							</div>
							<div class="col-lg-1">
								<img src="/public/common/image/uoc.PNG" id="uocImage">
							</div>
						</div>
					</div>
